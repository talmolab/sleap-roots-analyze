...
You are a senior scientific programmer reviewing an OpenSpec proposal for `sleap-roots-analyze`,
...
> You are reviewing an OpenSpec proposal for `sleap-roots-analyze`, a scientific Python package.
...
> You are reviewing an OpenSpec proposal's testing strategy for `sleap-roots-analyze`.
...
> You are reviewing an OpenSpec proposal for `sleap-roots-analyze`.
