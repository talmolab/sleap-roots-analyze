...
```python
# src/sleap_roots_analyze/<module>.py
...
```bash
git add src/sleap_roots_analyze/<module>.py tests/test_<module>.py
...
- Use `/verify-results` for end-to-end validation of pipeline outputs
