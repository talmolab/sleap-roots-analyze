...
class TestCreateIsolationForestPlots:
    ...
    def test_basic_plot_creation(self, outlier_viz_sample_data, outlier_viz_isolation_results):
    ...
    def test_with_error_results(self, outlier_viz_sample_data, outlier_viz_error_results):
        """Test handling of error results."""
        df, _ = outlier_viz_sample_data
        figures = create_isolation_forest_plots(df, outlier_viz_error_results["isolation_forest"])
...
class TestCreateOutliersPerGenotypePlot:
    ...
    def test_basic_plot_creation(
        ...
        fig = create_outliers_per_genotype_plot(
            df, outlier_viz_all_methods_results
        )
    ...
    def test_missing_genotype_column(
        self, outlier_viz_all_methods_results
    ):
...
class TestCreateMahalanobisOutlierPlots:
    ...
    def test_with_distance_threshold(self, outlier_viz_sample_data):
        ...
        fig = figures["mahalanobis_outlier_detection"]
        title = fig._suptitle.get_text() if hasattr(fig, '_suptitle') and fig._suptitle else ""
...
class TestCreatePcaOutlierPlot:
    ...
    def test_basic_plot_creation(self, outlier_viz_sample_data, outlier_viz_pca_results):
    ...
    def test_with_custom_figsize(self, outlier_viz_sample_data, outlier_viz_pca_results):
    ...
    def test_variance_explained_plot(self, outlier_viz_sample_data, outlier_viz_pca_results):
    ...
    def test_reconstruction_errors_plot(self, outlier_viz_sample_data, outlier_viz_pca_results):
    ...
    def test_pca_space_visualization(self, outlier_viz_sample_data, outlier_viz_pca_results):
    ...
    def test_feature_variance_explained(self, outlier_viz_sample_data, outlier_viz_pca_results):
...
class TestCreateComprehensiveOutlierComparison:
    ...
    def test_basic_comparison_plot(self, outlier_viz_all_methods_results):
        ...
        fig = create_comprehensive_outlier_comparison(
            outlier_viz_all_methods_results
        )
...
class TestIntegration:
    ...
    def test_full_pipeline_with_real_data(
        ...
        iso_figs = create_isolation_forest_plots(df_numeric, results["isolation_forest"])
        ...
        mahal_figs = create_mahalanobis_outlier_plots(df_numeric, results["mahalanobis"])
