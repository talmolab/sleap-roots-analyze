...
class TestSanitizeTraitNames:
    ...
    def test_data_preservation(self):
        ...
        result = sanitize_trait_names(
            df, trait_cols, abbreviate=False, barcode_col="barcode"
        )
    ...
    def test_non_trait_columns_unchanged(self):
        ...
        result = sanitize_trait_names(
            df, trait_cols, abbreviate=False, genotype_col="geno", barcode_col="barcode"
        )
    ...
    def test_metadata_genotype_variations(self):
        ...
        result1 = sanitize_trait_names(
            df1, ["trait"], sanitize_metadata=True, genotype_col="geno"
        )
        assert "Genotype" in result1.columns

        # Test "genotype"
        df2 = pd.DataFrame({"genotype": ["G1", "G2"], "trait": [1, 2]})
        result2 = sanitize_trait_names(
            df2, ["trait"], sanitize_metadata=True, genotype_col="genotype"
        )
        assert "Genotype" in result2.columns

        # Test "Genotype" (already correct - no change)
        df3 = pd.DataFrame({"Genotype": ["G1", "G2"], "trait": [1, 2]})
        result3 = sanitize_trait_names(
            df3, ["trait"], sanitize_metadata=True, genotype_col="Genotype"
        )
    ...
    def test_metadata_replicate_variations(self):
        ...
        result1 = sanitize_trait_names(
            df1, ["trait"], sanitize_metadata=True, replicate_col="rep"
        )
        ...
        result2 = sanitize_trait_names(
            df2, ["trait"], sanitize_metadata=True, replicate_col="replicate"
        )
    ...
    def test_metadata_barcode_variations(self):
        ...
        result1 = sanitize_trait_names(
            df1, ["trait"], sanitize_metadata=True, barcode_col="barcode"
        )
        ...
        result2 = sanitize_trait_names(
            df2, ["trait"], sanitize_metadata=True, barcode_col="Barcode"
        )
    ...
    def test_custom_replacement_basic(self):
        ...
        result = sanitize_trait_names(
            df, trait_cols, custom_replacements={"crown": "seminal"}
        )
    ...
    def test_custom_replacement_with_abbreviations(self):
        ...
        result = sanitize_trait_names(
            df, trait_cols, custom_replacements={"crown": "seminal"}, abbreviate=True
        )
