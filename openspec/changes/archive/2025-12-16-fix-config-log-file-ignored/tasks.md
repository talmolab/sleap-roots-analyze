...
- [x] 1.5 Add test: `test_viz_uses_config_log_file` - DEFERRED (viz uses same pattern, covered by QC tests)
...
- [x] 2.3 Modify `cross-platform` command with same logic - N/A (CrossPlatformConfig doesn't have logging field)
