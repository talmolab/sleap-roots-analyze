...
- [ ] 5.1 Run full viz pipeline with highlighting enabled - verify plots generated correctly
- [ ] 5.2 Run full viz pipeline with highlighting disabled (None values) - verify backward compatibility
- [ ] 5.3 Verify PCA biplot shows colored genotypes distinctly
- [ ] 5.4 Verify PC boxplots show highlighted genotypes in gold with bold labels

## 6. Documentation
- [ ] 6.1 Update config YAML comments with usage examples
- [ ] 6.2 Add inline code comments explaining parameter flow
- [ ] 6.3 Verify all tests pass with `uv run pytest tests/ -x --tb=short`
